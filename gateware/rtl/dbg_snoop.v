...
module dbg_snoop #(
    ...
    reg [15:0] wsent_l;
    reg [9:0]  xtra;                           // pending K/k/W/w/P/p/N/H/V/v emissions
    reg [7:0] last_s;
    ...
    always @(posedge clk or negedge rst_n) begin
        if (!rst_n) begin
            ...
            else if (rst_rise)                  begin ev <= {"r", 8'h01}; ev_wr <= 1'b1; arm_s <= 1'b1; last_s <= 8'h00; end
